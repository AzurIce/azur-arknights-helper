//! A normalized cross correlation matcher
...
pub struct CrossCorrelationNormedMatcher {
    ctx: Context,
...
mod test {
    ...
    use super::CrossCorrelationNormedMatcher;

    #[test]
    fn test_cross_correlation_normed_match() {
        let mut matcher = CrossCorrelationNormedMatcher::new();
