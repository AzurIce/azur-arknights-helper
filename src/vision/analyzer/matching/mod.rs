...
impl Into<MatchTemplateMethod> for MatchMethod {
    fn into(self) -> MatchTemplateMethod {
        match self {
            MatchMethod::SumOfSquaredDifference => MatchTemplateMethod::SumOfSquaredDifference,
            MatchMethod::SumOfSquaredDifferenceNormed => MatchTemplateMethod::SumOfSquaredDifferenceNormed,
            MatchMethod::CrossCorrelation => MatchTemplateMethod::CrossCorrelation,
            MatchMethod::CrossCorrelationNormed => MatchTemplateMethod::CrossCorrelationNormed,
            MatchMethod::CorrelationCoefficient => MatchTemplateMethod::CorrelationCoefficient,
            MatchMethod::CorrelationCoefficientNormed => MatchTemplateMethod::CorrelationCoefficientNormed,
        }
    }
}
...
pub struct MatchOptions {
    /// The matching method
    pub(crate) method: Option<MatchMethod>,
